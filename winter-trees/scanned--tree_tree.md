# WINTER TREE — [scanned] tree

- Famille : 🌳 Baobab
- Domaine : audio
- Date plantation : 2026-02-15T10:10:33.056017
- Phase : CROISSANCE
...
```yaml
- id: M1
  label: "Langage principal : Python (3401 lignes)"
  status: done
  entry: ~
  depends: []
```
...
```yaml
- id: T1
  label: "Core : engine.py (3401 lignes, Python)"
  status: done
  entry: engine.py
  depends: []
```
...
- ⬜ **Phase 2** : Tronc — core engine MASSIF
